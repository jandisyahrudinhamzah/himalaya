...
<div class="flex min-h-screen">
    ...
    <div class="w-9 h-9 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg flex items-center justify-center shadow-lg overflow-hidden">
        ...
        <img src="{{ asset('image/himalayalogo.jpeg') }}" 
             alt="HIMALAYA Logo" 
    ...
    <div>
        ...
        <nav class="flex-1 px-3 py-4 space-y-0.5">
            ...
            <a href="{{ route('admin.dashboard') }}"
               ...
               {{ request()->routeIs('admin.dashboard') ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
            ...
            <a href="{{ route('admin.artikel.index') }}"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all
               {{ request()->routeIs('admin.artikel.*') ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
            ...
            <a href="{{ route('admin.kegiatans.index') }}"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all
               {{ request()->routeIs('admin.kegiatans.*') ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
            ...
            <a href="{{ route('admin.anggota.index') }}"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all
               {{ request()->routeIs('admin.anggota.*') ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
            ...
            <a href="{{ route('admin.galeri.index') }}"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all
               {{ request()->routeIs('admin.galeri.*') ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
            ...
            <a href="{{ route('admin.struktur.index') }}"
               class="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium transition-all
               {{ request()->routeIs('admin.struktur.*') ? 'bg-blue-600 text-white' : 'text-white/60 hover:bg-white/10 hover:text-white' }}">
